  ...
  useEffect(() => {
    const fetchLeads = async () => {
      ...
      if (token) {
        ...
        try {
          // Fetch shared leads
          const sharedResponse = await axios.get(` http://localhost:6003/api/shared-leads/shared?userId=${userId}`, {
          ...
          const receivedResponse = await axios.get(` http://localhost:6003/api/shared-leads/received?userId=${userId}`, {
            headers: { Authorization: `Bearer ${token}` }
          });
