    ...
    return (
        <FriendsContainer>
            {friends.length > 0 ? (
                ...
                <NoFriendsMessage>Welcome to the Associate Network! You are New Here, Please search you associate if you know his/her ID or send invitation to Join.</NoFriendsMessage>
            )}
        </FriendsContainer>
    );
};
