...
const IndustrialForPurchase = ({
  ...
  console.log('IndustrialForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Industrial Land For Purchase</Title>
...
IndustrialForPurchase.propTypes = {
...
export default IndustrialForPurchase;