...
const OfficeForSale = ({
  ...
  console.log('OfficeForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      ...
      />
         ...
         <StreetInput
           label="Street or Road Name/Number"
           name="streetName"
