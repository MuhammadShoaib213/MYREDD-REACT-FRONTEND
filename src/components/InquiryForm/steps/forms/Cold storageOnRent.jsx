...
const ColdstorageOnRent = ({
  ...
  console.log('ColdstorageOnRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Coldstorage On Rent</Title>
...
export default ColdstorageOnRent;