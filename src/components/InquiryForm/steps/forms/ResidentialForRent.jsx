...
const ResidentialForRent = ({
  ...
  console.log('ResidentialForRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Residential Land For Rent</Title>
...
export default ResidentialForRent;
