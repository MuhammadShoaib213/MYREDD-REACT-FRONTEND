...
const HeavymanufacturingOnRent = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('HeavymanufacturingOnRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Heavymanufacturing On Rent</Title>
...
HeavymanufacturingOnRent.propTypes = {
...
export default HeavymanufacturingOnRent;