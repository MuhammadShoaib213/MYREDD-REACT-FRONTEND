...
const AgricultureForPurchase = ({
  ...
  console.log('AgricultureForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Agriculture Land For Purchase</Title>
...
AgricultureForPurchase.propTypes = {
...
export default AgricultureForPurchase;