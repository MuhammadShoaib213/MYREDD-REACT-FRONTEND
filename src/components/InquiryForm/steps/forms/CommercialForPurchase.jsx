...
const CommercialForPurchase = ({
  ...
  console.log('CommercialForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Commercial Land For Purchase</Title>
...
CommercialForPurchase.propTypes = {
...
export default CommercialForPurchase;