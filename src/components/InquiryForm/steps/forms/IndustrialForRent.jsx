...
const IndustrialForRent = ({
  ...
  console.log('IndustrialForRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Industrial Land For Rent</Title>
...
export default IndustrialForRent;
