...
const VillasForPurchase = ({
  ...
  console.log('VillasForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Villas For Purchase</Title>
...
export default VillasForPurchase;