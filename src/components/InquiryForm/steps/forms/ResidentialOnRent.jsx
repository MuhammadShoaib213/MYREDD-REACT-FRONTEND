...
const ResidentialOnRent = ({
  ...
  console.log('ResidentialOnRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Residential Land On Rent</Title>
...
export default ResidentialOnRent;