...
const WarehouseForPurchase = ({
  ...
  console.log('WarehouseForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Warehouse For Purchase</Title>
...
WarehouseForPurchase.propTypes = {
...
export default WarehouseForPurchase;