...
const IndustrialForSale = ({
  ...
  console.log('IndustrialForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Industrial Land For Sale</Title>
...
export default IndustrialForSale;
