...
const LightmanufacturingForRent = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('LightmanufacturingForRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Light manufacturing For Rent</Title>
...
LightmanufacturingForRent.propTypes = {
...
export default LightmanufacturingForRent;
