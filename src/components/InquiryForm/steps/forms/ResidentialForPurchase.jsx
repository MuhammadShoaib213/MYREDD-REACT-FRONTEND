...
const ResidentialForPurchase = ({
  ...
  console.log('ResidentialForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Residential Land For Purchase</Title>
...
ResidentialForPurchase.propTypes = {
...
export default ResidentialForPurchase;