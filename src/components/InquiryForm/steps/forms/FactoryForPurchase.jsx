...
const FactoryForPurchase = ({
  ...
  console.log('FactoryForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Factory For Purchase</Title>
...
export default FactoryForPurchase;