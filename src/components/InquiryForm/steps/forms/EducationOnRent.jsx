...
const EducationOnRent = ({
  ...
  console.log('EducationOnRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Education Land On Rent</Title>
...
export default EducationOnRent;