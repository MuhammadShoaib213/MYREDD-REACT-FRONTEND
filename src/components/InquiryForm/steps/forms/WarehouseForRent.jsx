...
const WarehouseForRent = ({
  ...
  console.log('WarehouseForRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Warehouse For Rent</Title>
...
export default WarehouseForRent;
