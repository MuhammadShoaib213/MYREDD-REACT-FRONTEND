...
const LightmanufacturingOnRent = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('LightmanufacturingOnRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Light manufacturing On Rent</Title>
...
LightmanufacturingOnRent.propTypes = {
...
export default LightmanufacturingOnRent;