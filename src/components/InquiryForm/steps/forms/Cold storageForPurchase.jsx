...
const ColdstorageForPurchase = ({
  ...
  console.log('ColdstorageForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Cold storage For Purchase</Title>
...
ColdstorageForPurchase.propTypes = {
...
export default ColdstorageForPurchase;