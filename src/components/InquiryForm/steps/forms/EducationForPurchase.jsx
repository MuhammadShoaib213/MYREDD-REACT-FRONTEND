...
const EducationForPurchase = ({
  ...
  console.log('EducationForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Education Land For Purchase</Title>
...
EducationForPurchase.propTypes = {
...
export default EducationForPurchase;