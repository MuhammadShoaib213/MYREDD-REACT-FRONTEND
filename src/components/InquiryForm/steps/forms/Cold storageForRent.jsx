...
const ColdstorageForRent = ({
  ...
  console.log('ColdstorageForRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Cold storage For Rent</Title>
...
export default ColdstorageForRent;
