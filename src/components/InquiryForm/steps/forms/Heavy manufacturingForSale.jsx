...
const HeavyManufacturingForSale = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('HeavyManufacturingForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Heavy Manufacturing For Sale</Title>
...
HeavyManufacturingForSale.propTypes = {
...
export default HeavyManufacturingForSale;
