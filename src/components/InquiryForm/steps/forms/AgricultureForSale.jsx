...
const AgricultureForSale = ({
  ...
  console.log('AgricultureForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Agriculture Land For Sale</Title>
...
export default AgricultureForSale;
