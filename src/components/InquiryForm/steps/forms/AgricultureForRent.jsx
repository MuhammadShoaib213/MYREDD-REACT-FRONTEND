...
const AgricultureForRent = ({
  ...
  console.log('AgricultureForRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Agriculture Land For Rent</Title>
...
export default AgricultureForRent;
