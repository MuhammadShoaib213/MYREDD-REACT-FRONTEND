// HeavymanufacturingOnPurchase.jsx
...
const HeavymanufacturingOnPurchase = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('HeavymanufacturingOnPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Heavy manufacturing For Purchase</Title>
...
HeavymanufacturingOnPurchase.propTypes = {
...
export default HeavymanufacturingOnPurchase;