...
const WarehouseForSale = ({
  ...
  console.log('WarehouseForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Warehouse For Sale</Title>
...
export default WarehouseForSale;
