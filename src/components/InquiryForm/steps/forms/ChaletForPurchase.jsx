...
const ChaletForPurchase = ({
  ...
  console.log('ChaletForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Chalet For Purchase</Title>
...
export default ChaletForPurchase;