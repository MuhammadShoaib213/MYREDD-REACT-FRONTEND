...
const DuplexForPurchase = ({
  ...
  console.log('DuplexForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Duplex For Purchase</Title>
...
export default DuplexForPurchase;