...
const ApartmentForPurchase = ({
  ...
  console.log('ApartmentForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Apartment For Purchase</Title>
...
ApartmentForPurchase.propTypes = {
...
export default ApartmentForPurchase;