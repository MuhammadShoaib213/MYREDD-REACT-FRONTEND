...
const BuildingForPurchase = ({
  ...
  console.log('BuildingForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Building For Purchase</Title>
...
export default BuildingForPurchase;