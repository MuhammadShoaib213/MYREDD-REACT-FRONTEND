// LightmanufacturingForPurchase.jsx
...
const LightmanufacturingForPurchase = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('LightmanufacturingForPurchase received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Light manufacturing For Purchase</Title>
...
LightmanufacturingForPurchase.propTypes = {
...
export default LightmanufacturingForPurchase;