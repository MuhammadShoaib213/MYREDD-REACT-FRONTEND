...
const ColdstorageForSale = ({
  ...
  console.log('ColdstorageForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Cold storage For Sale</Title>
...
export default ColdstorageForSale;
