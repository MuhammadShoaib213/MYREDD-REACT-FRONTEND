...
const IndustrialOnRent = ({
  ...
  console.log('IndustrialOnRent received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Industrial Land On Rent</Title>
...
export default IndustrialOnRent;