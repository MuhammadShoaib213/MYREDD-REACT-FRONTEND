...
const EducationForSale = ({
  ...
  console.log('EducationForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Education Land For Sale</Title>
...
export default EducationForSale;
