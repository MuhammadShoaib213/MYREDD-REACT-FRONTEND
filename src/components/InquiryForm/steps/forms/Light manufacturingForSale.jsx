...
const LightmanufacturingForSale = ({
  formData,
  handleChange,
  handleFilesChange,
  handleFloorChange,
  ...
  console.log('LightmanufacturingForSale received props:', {
    formData,
    handleChange,
    handleFilesChange,
    handleFloorChange,  
  ...
  return (
    <FormContainer>
      <Title>Light Manufacturing For Sale</Title>
...
LightmanufacturingForSale.propTypes = {
...
export default LightmanufacturingForSale;
