...
// //       try {
// //         const response = await axios.get(' http://localhost:6003/api/friend/requests', {
...
// //     try {
// //       await axios.put(' http://localhost:6003/api/friend/update', { 
// //         friendsId: requestId,
// //         action: 'accept'
// //       }, {
// //         headers: { Authorization: `Bearer ${token}` }
...
const ProfitContent = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(' http://localhost:6003/api/properties')
      .then((res) => {
...
const BusinessAssociatesPage = () => {
  ...
  const handleAcceptFriendRequest = async (requestId) => {
    try {
      await axios.put(
        ' http://localhost:6003/api/friend/update',
