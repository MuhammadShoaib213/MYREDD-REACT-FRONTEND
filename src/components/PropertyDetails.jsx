...
const formatPropertySubType = (subType) => {
  ...
  if (typeof subType === 'string') {
    ...
    // Return the first key with a truthy value
...
const getPropertySubType = (subTypes) => {
  // This function returns a single subtype string
  if (!subTypes) return 'Unknown';
  if (typeof subTypes === 'string') {
    return subTypes.charAt(0).toUpperCase() + subTypes.slice(1);
  } else if (typeof subTypes === 'object') {
          ...
          <DetailSection>
            ...
            <DetailItem>
              ...
              <Value>
                Rs{' '}
                {property.budget
                  ? Number(property.budget).toLocaleString()
                  : 'Price Not Available'}
              </Value>
            </DetailItem>
            <DetailItem>
